...
\include{./chap/2-resultados-preliminares}

% Teoria dos Jogos Clássica
\include{./chap/3-teoria-jogos-classica}

% Teoria dos Jogos evolucionarios
\include{./chap/4-jogos-evolucionarios}

% Teoria dos Jogos evolucionarios em Redes Finitas
\include{./chap/5-jogos-evolucionarios-redes}

% Hiper-racionalidade
\include{./chap/6-hiper-racionalidade}

% Jogos com Jogadores Hiper-racionais
\include{./chap/7-jogos-hiper-racionais}

% Equação de replicação Hiper-racional em redes finitas
\include{./chap/8-eq-rep-hr-redes-finitas}

% O Jogo do Triângulo Amoroso
\include{./chap/9-triangulo-amoroso}
